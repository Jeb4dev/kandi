...
\title{IoT-pohjainen sisätilapaikannus: Tehokkaan varastonhallinnan avain} % Työsi otsikko
\title[english]{IoT-based Indoor Positioning: The Key to Efficient Warehouse Management} % Otsikko englanniksi
...
\secondsupervisor{Ville SUKUNIMI} % Toisen ohjaajan, jos on, nimi
\keywords{Sisätilapaikannus\sep AVAINSANA2\sep JNE} % Avainsanat erotetaan \sep-komennolla
\keywords[english]{Indoor Positioning\sep KEYWORD2\sep ETC} % Avainsanat englanniksi
...
\begin{description}
    \item[Pääkysymys:] Miten IoT-pohjainen sisätilapaikannus voi ratkaista varastonhallinnan haasteet ja parantaa sen tehokkuutta?
    \begin{description}
        \item[Alakysymys 1:] Mitkä ovat keskeiset haasteet, joita varastonhallinta kohtaa, ja miten IoT-pohjainen sisätilapaikannus voi auttaa niiden ratkaisemisessa?
        \item[Alakysymys 2:] Mitkä ovat eri IoT-teknologioiden, kuten RFID:n, Wi-Fi:n, Bluetoothin, UWB:n ja Zigbeen, keskeiset vahvuudet ja heikkoudet sisätilapaikannuksen kontekstissa?
        \item[Alakysymys 3:] Miten IoT-pohjainen sisätilapaikannusratkaisu toteutetaan käytännössä?
    \end{description}
\end{description}
...
\chapter{Teoria}
\label{cha:teoria}
Määritellään käsitteet Sisätilapaikannus, IoT, varastonhallinta
...
Valitut aineistot: noin 20 artikkelia
...
\section{Mitkä ovat keskeiset haasteet, joita varastonhallinta kohtaa, ja miten IoT-pohjainen sisätilapaikannus voi auttaa niiden ratkaisemisessa?}

Mitkä ovat keskeiset haasteet, joita varastonhallinta kohtaa, ja miten IoT-pohjainen sisätilapaikannus voi auttaa niiden ratkaisemisessa?

\section{Mitkä ovat eri IoT-teknologioiden keskeiset vahvuudet ja heikkoudet sisätilapaikannuksen kontekstissa?}

Mitkä ovat eri IoT-teknologioiden, kuten RFID:n, Wi-Fi:n, Bluetoothin, UWB:n ja Zigbeen, keskeiset vahvuudet ja heikkoudet sisätilapaikannuksen kontekstissa?

\section{Miten IoT-pohjainen sisätilapaikannusratkaisu toteutetaan käytännössä? }

Miten IoT-pohjainen sisätilapaikannusratkaisu toteutetaan käytännössä?

\section{Tekninen ratkaisun tarkastelu}

(voi olla myös analyysi luvussa)
